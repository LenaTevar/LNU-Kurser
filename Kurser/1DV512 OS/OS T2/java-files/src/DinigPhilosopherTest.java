...
public class DinigPhilosopherTest {
	...
	public void test3() throws InterruptedException {
		...
		ArrayList<Philosopher> philosophers = dp.getPhilosophers(); // get the philosophers
		 ...
		 /* the following code prints a table where each row corresponds to one of the Philosophers,
		 * columns correspond to the Philosopher ID (PID), average think time (ATT), average eating time (AET), average hungry time (AHT), number of thinking turns(#TT)
		 *  number of eating turns(#ET), and number of hungry turns(#HT).*/
