...
* I actually copy-pasted what I did in Java 1.
* If it stupid but it works...
* */

public class HistoClassFx {
    ...
    public HistoClassFx (String user) throws FileNotFoundException {
        this.text = user;
        file = new File(text);
